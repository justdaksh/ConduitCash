...
export default function Home() {
  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen bg-gradient-to-br from-gray-100 to-gray-300 px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-12">
        <div className="w-full max-w-xs sm:max-w-sm lg:max-w-md h-24 flex justify-center items-center mx-auto">
          <img
      ...
      <div className="space-y-6 w-full max-w-xs sm:max-w-sm lg:max-w-md">
        <button
